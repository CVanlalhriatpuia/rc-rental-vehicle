...
?>
    ...
    <h2 class="text-center"> Thank you for visiting RC Vehicle Rentals! We wish you have a safe ride. </h2>
    ...
    <div class="container">
        ...
        <div class="box">
            ...
            ?></h4>
                ...
                <br>
                <h4> <strong>Return Date: </strong> <?php echo $car_return_date; ?> </h4>
                <br>
