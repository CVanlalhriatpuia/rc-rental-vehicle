...
<!-- Navigation -->
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="background-color: rgba(66, 245, 123, 0.5); color: black">
        <div class="container">
...
<?php        } ?>
        ...
        <div class="container">
      <div class="jumbotron">
        <h1 class="text-center">You have not rented any Vehicle till now!</h1>
        <p class="text-center"> Please rent Vehicle in order to view your data here. </p>
      </div>
    </div>
...
<footer class="site-footer">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h5>© <?php echo date("Y"); ?> Admin Rentals</h5>
                </div>
            </div>
        </div>
    </footer>
